      ...
      xOriginalMessageId:(NSString *)xOriginalMessageIdString
{
    self = [ super init ];
    if ( self ) {
        attachment = attachmentArray;   /* Attachment: */
        bcc = bccArray;                 /* Bcc: */
        cc = ccArray;                   /* Cc: */
        date = aDate;                   /* Date: */
        from = fromAddress;              /* From: */
        fromName = fromNameString;      /* FromName: */
        inReplyTo = inReplyToString;    /* In-Reply-To: */
        messageID = messageIDString;    /* Message-ID: */
        references = referencesString;  /* References: */
        replyTo = replyToPerson;        /* Reply-To: */
        subject = subjectString;        /* Subject: */
        to = toArray;                   /* To: */
        xOMELocale = xOMELocaleString;  /* X-OME-Locale: */
